...
class BrailleToMolds:
    ...
    def __init__(self):
        ...
        file_path = "C:\\Users\\ramit\\Braillest\\automation\data\\pages\\1.txt"
        ...
        stl_path = "C:\\Users\\ramit\\Braillest\\automation\data\\minimal_negative.stl"
        bpy.ops.wm.stl_export(filepath=stl_path, export_selected_objects=True, global_scale=scaling_factor)
        ...
        stl_path = "C:\\Users\\ramit\\Braillest\\automation\data\\minimal_positive.stl"
        bpy.ops.wm.stl_export(filepath=stl_path, export_selected_objects=True, global_scale=scaling_factor)
